...
import com.bluexiii.reportman.dto.CommonResp;
...
public class ReportManController {
    ...
    @PostMapping("/reports")
    public CommonResp reports(@ApiParam(value = "示例: {\"file.prefix\": \"demo\", \"mail.to.list\": \"foo@bar.com\", \"sql.start_date\": \"2017-10-1\",\"sql.end_date\": \"2017-10-31\"}", required = true)
        ...
        // 生成报表
        reportManService.init(filePrefix, paramMap);
        reportManService.makeReportAsync();

        return new CommonResp("0000", "报表生成中，稍后会发送至您的邮箱。请不要重复点击生成报表。");
    }
}